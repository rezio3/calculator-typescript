...
numbers.forEach(function(button) {
    button.addEventListener("click", function() {
        if (operatorActive !== "none") {
            ...
            } else if (resultSpan.innerHTML === "0") resultSpan.innerHTML = button.innerHTML;
            else resultSpan.innerHTML += button.innerHTML;
        } else if (resultSpan.textContent !== "0") resultSpan.innerHTML += button.innerHTML;
        else resultSpan.innerHTML = button.innerHTML;
...
dot.addEventListener("click", function() {
    if (resultSpan.innerHTML.indexOf(".") === -1) resultSpan.innerHTML += ".";
});
...
function checkIfResultTooLong() {
    ...
    if (resultLength > 12) {
        ...
        for(var i = resultLength; i > 12; i--)newDisplayArr.pop();
